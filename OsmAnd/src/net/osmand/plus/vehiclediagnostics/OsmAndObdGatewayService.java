 ...
 */
public class OsmAndObdGatewayService extends Service {

	private static final String TAG = "OsmAndObdGatewayService";
...
//		        ConfigActivity.BLUETOOTH_LIST_KEY, null);
		String remoteDevice = "11:22:33:AA:BB:CC";
		
		Log.i(TAG, "Connecting to OBD device with address " + remoteDevice);
...
//		if(_dev.getBondState() != BluetoothDevice.BOND_BONDED) {
//			
//			pairDevice(_dev);
//		}
